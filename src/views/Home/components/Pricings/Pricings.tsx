...
import { Icon, LearnMoreLink } from 'src/components/atoms';
import { SectionHeader } from 'src/components/molecules';
import { CardPricingStandard } from 'src/components/organisms';
...
const Pricings = (props: PricingsProps): ReactElement => {
